...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAx0CT-AjQwABKF1EZDzrHZLmXqJFGHm4nUzTCyuC7zUAAp0NAALt07BUPuiWEGt7JPwvBA")
        ...
        if name[0:3] == "sta":
            m = await message.reply_text(
                f"🥱 sᴜɴᴏ sᴇᴇᴅᴀ sᴀ sɪᴍᴘʟᴇ sᴀ ᴇᴋ ʙᴀᴀᴛ ʙᴏʟᴜ . ᴛʜᴏ sᴜɴᴏ {config.MUSIC_BOT_NAME} sᴇʀᴠᴇʀ."
            )
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/kimjikoinsupport) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/kimjikoinsupport"
                        ),
                    ],
                ]
            )
